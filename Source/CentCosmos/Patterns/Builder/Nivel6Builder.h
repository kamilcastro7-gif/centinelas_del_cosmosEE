...
#include "Nivel6Builder.generated.h"

class AEnemyFactory;
class AGeneradorAmbientacion;

UCLASS()
class CENTCOSMOS_API ANivel6Builder : public AActor, public INivelBuilder
{
    GENERATED_BODY()
...
private:
    ...
    void SpawnEclipsesSilenciosos(AGeneradorAmbientacion* G, int32 N);
